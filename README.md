...
A instrução CMP comparam o valor em um registrador.
    
    CMP{cond} Rn, Operand2
    ou
    CMP{cond} Rn, #valorImediato

Onde, cond é um código de condição opcional.Rn é o registrador ARM contendo o primeiro operando. Operand2 é um segundo operando. #valorImediato 
